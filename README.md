...
| `DATA_DIRECTORY`     | The directory where the `sqlite` database is stored                       |
...
| `SEARCH_STATE_RESET` | The interval (in minutes) after which a media item will be searched again |
